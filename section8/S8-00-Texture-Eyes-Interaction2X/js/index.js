...
function render() {
	...
	for (var i = 0; i < eyesNum; i++) {
		...
		if (mouseX<300) eyes[1].rotation.y = map_range(mouseX, 0, 300, -0.2, 0.25);
		else eyes[1].rotation.y = map_range(mouseX, 300, window.innerWidth, 0.25, 1.14);
		...
		if (mouseX<300) eyes[3].rotation.y = map_range(mouseX, 0, 300, -0.2, 0.25);
		else eyes[3].rotation.y = map_range(mouseX, 300, window.innerWidth, 0.25, 1.14);
